...
function getLocalSchool(): SchoolConfig {
  try {
    ...
    if (raw) {
      ...
      if (cfg.kepalaSekolah === 'Drs. H. Mulyono, M.Pd.' || !cfg.kepalaSekolah) {
        cfg.kepalaSekolah = 'Drs. Dihan Narso, M.Pd.';
      }
      if (cfg.ketuaBkk === 'Akhmad Fauzi, S.T., M.Kom.' || !cfg.ketuaBkk) {
        cfg.ketuaBkk = 'M. Dedi Safarudin, S.Kom.';
      }
